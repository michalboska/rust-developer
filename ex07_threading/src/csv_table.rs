...
impl CsvTable {
    ...
    fn process_body_value(
        index: usize,
        value: &str,
        row: &mut Vec<String>,
        csv_struct: &mut CsvTable,
    ) {
    ...
    fn get_header_or_spacing_row(&self, use_col_titles: bool) -> String {
        ...
        for col in &self.columns {
            if use_col_titles {
                let padded_title = col
                    .title
                    .pad_to_width_with_alignment(col.max_length, Alignment::Middle);
    ...
    fn get_body_row(&self, row: &Vec<String>) -> String {
        ...
        for i in 0..row.len() {
            ...
            let padded_value =
                &row[i].pad_to_width_with_alignment(col.max_length, Alignment::Middle);
